const validation: any = {
  ...
  number_of_characters_must_be_more_than: 'Number of characters must be more than',
  number_of_characters_must_be_less_than: 'Number of characters must be less than',
  ...
  operation_not_completed_try_again_later: 'Operação não concluída, please try again later',
