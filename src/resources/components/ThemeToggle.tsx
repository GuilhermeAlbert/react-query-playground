import { ThemeTypes } from "@/app/contexts/theme/enums/theme.type.enum";
import { useTheme } from "@/app/contexts/theme/hooks/theme.hook";

export default function ThemeToggle() {
  const { state: themeState, changeTheme } = useTheme();
  ...
  return (
    <div>
      <input
        ...
        checked={themeState.theme === ThemeTypes.Light}
        onChange={() =>
          changeTheme(
